package com.match.library.utils.common;
/*
 *
 *  *
 *  *  * ===================================
...
//    };
     ...
     * 定位
     */
    public static String[] LOCATION = {//定位权限
            ...
            for (String permission : denidArray) {
                ...
                if (!showRationaleUI(activity, permission)) {
                    ...
                    if (!isAppFirstRun(activity)) {
                        Logcat.e("进入授权权限");
                        Toast.makeText(activity, "请先开启权限", Toast.LENGTH_SHORT).show();
                    }
                }
                break;
            }
    ...
    public static boolean isAppFirstRun(Activity activity) {
        ...
        if (sp.getString("first_run", "true").equals("true")) {
