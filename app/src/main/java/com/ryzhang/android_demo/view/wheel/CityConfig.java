package com.ryzhang.android_demo.view.wheel;
...
public class CityConfig {
     ...
     * Default text color
     */
    public static final String DEFAULT_TEXT_COLOR = "#C7C7C7";
     ...
     * Color.BLACK
     */
    private String cancelTextColorStr = "#414146";

    /**
     * Color.BLUE
     */
    private String confirmTextColorStr = "#414146";
     ...
     * 标题颜色
     */
    private String titleTextColorStr = "#414146";
     ...
     */
    private String defaultCityName = "杨浦区";
    ...
    public static class Builder {
         ...
         * 第一次默认得显示城市，一般配合定位，使用
         */
        private String defaultCityName = "杨浦";
